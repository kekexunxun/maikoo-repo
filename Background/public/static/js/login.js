      ...
      $.ajax({
        ...
        success: function(res){
          ...
          if (res.code == "0") {
            ...
            setTimeout("window.location.href='http://testart.up.maikoo.cn/index'", 1000);
          }else if (res.code == "100") {
            layer.msg('账号不存在!',{icon:2,time:2000});
          }else if (res.code == "300") {
            layer.msg('密码错误!',{icon:2,time:2000});
          }else if(res.code == "400"){
            layer.msg('账号未启用，请联系最高管理员启用!',{icon:2,time:2000});
          }else if(res.code == "500"){
            layer.msg('账号已失效，请联系最高管理员!',{icon:2,time:2000});
          }
        }
      });
    }
