...
class Mini extends Controller
{
        ...
        if ($insert) {
            ...
            foreach ($userAccountInfo as $k => $v) {
                if ($v['user_openid'] == $userOpenid) {
                    $userAccountInfo[$k]['userInfo'] = $userInfoBack;
                    break 1;
                }
            }
    ...
    public function test()
    {
        ...
        //     if (isset($v['userInfo']['nickname'])) {
        //         $userInfo[$k]['userInfo']['nickName'] = $v['userInfo']['nickname'];
        //         unset($userInfo[$k]['userInfo']['nickname']);
        //     }
        //     if (isset($v['userInfo']['avatar_url'])) {
        //         $userInfo[$k]['userInfo']['avatarUrl'] = $v['userInfo']['avatar_url'];
        //         unset($userInfo[$k]['userInfo']['avatar_url']);
        //     }
        // }
        // dump($userInfo);
