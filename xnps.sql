...
CREATE TABLE `mk_area`  (
  ...
  `code` int(11) NOT NULL COMMENT '地区code',
  `pcode` int(11) NOT NULL COMMENT '地区上级code',
  `node` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '节点',
  `name` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称',
  `level` tinyint(4) NOT NULL COMMENT '级别',
  PRIMARY KEY (`idx`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 46540 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for mk_article
-- ----------------------------
DROP TABLE IF EXISTS `mk_article`;
...
-- ----------------------------
-- Table structure for mk_catagory
-- ----------------------------
DROP TABLE IF EXISTS `mk_catagory`;
CREATE TABLE `mk_catagory`  (
...
-- ----------------------------
-- Table structure for mk_clause
-- ----------------------------
DROP TABLE IF EXISTS `mk_clause`;
CREATE TABLE `mk_clause`  (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for mk_column
-- ----------------------------
DROP TABLE IF EXISTS `mk_column`;
CREATE TABLE `mk_column`  (
...
-- ----------------------------
-- Table structure for mk_column_goods
-- ----------------------------
DROP TABLE IF EXISTS `mk_column_goods`;
CREATE TABLE `mk_column_goods`  (
...
-- ----------------------------
-- Table structure for mk_coupon
-- ----------------------------
DROP TABLE IF EXISTS `mk_coupon`;
...
-- ----------------------------
-- Table structure for mk_feedback
-- ----------------------------
DROP TABLE IF EXISTS `mk_feedback`;
CREATE TABLE `mk_feedback`  (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for mk_goods_comment
-- ----------------------------
DROP TABLE IF EXISTS `mk_goods_comment`;
CREATE TABLE `mk_goods_comment`  (
  `comment_id` int(11) NOT NULL AUTO_INCREMENT COMMENT ' ',
  `order_sn` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '订单编号',
  `goods_id` int(11) NOT NULL DEFAULT 0 COMMENT '商品ID',
  `comment` varchar(140) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '单商品的评价',
  `satisfaction` tinyint(4) NOT NULL DEFAULT 1 COMMENT '商品满意度 1 好评 2 中评 3 差评',
  `created_at` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '评论时间',
  `created_by` int(11) NOT NULL DEFAULT 0 COMMENT '评论人的ID',
...
-- ----------------------------
-- Table structure for mk_merchant
-- ----------------------------
DROP TABLE IF EXISTS `mk_merchant`;
CREATE TABLE `mk_merchant`  (
  `idx` int(11) NOT NULL AUTO_INCREMENT COMMENT '索引ID',
  `mch_id` int(11) NOT NULL COMMENT '商家ID',
  `mch_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '商家名称',
  `mch_logo` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '商家LOGO',
  `mch_cert` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '商家申请证书资质 图片2张以内',
  `status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0未营业1正常营业2暂停营业3已删除',
  `pause_at` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '暂停时间',
  ...
  `address_code` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '商家所在省市区code 1_2_3',
  `address` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '商家具体位置',
  `created_at` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '创建时间',
  `update_at` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '更新时间',
  PRIMARY KEY (`idx`) USING BTREE
...
-- ----------------------------
-- Table structure for mk_merchant_apply
-- ----------------------------
DROP TABLE IF EXISTS `mk_merchant_apply`;
CREATE TABLE `mk_merchant_apply`  (
  `idx` int(11) NOT NULL AUTO_INCREMENT COMMENT '索引ID',
  `mch_id` int(11) NOT NULL COMMENT '商家ID',
...
-- ----------------------------
-- Table structure for mk_merchant_comment
-- ----------------------------
DROP TABLE IF EXISTS `mk_merchant_comment`;
CREATE TABLE `mk_merchant_comment`  (
  `comment_id` int(11) NOT NULL AUTO_INCREMENT COMMENT ' ',
...
-- ----------------------------
-- Table structure for mk_merchant_log
-- ----------------------------
DROP TABLE IF EXISTS `mk_merchant_log`;
CREATE TABLE `mk_merchant_log`  (
  `idx` int(11) NOT NULL AUTO_INCREMENT COMMENT '索引ID',
  `mch_id` int(11) NOT NULL COMMENT '商家ID',
...
-- ----------------------------
-- Table structure for mk_merchant_stock
-- ----------------------------
DROP TABLE IF EXISTS `mk_merchant_stock`;
CREATE TABLE `mk_merchant_stock`  (
...
CREATE TABLE `mk_order`  (
  ...
  `uid` int(11) NOT NULL COMMENT '用户ID',
  `mch_id` int(11) NOT NULL DEFAULT 0 COMMENT '店铺ID',
  `mch_name` char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '店铺名称',
  `total_fee` decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '该订单总价',
  `coupon_id` int(11) NOT NULL DEFAULT 0 COMMENT '卡券ID',
  ...
  `delivery_at` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '配送时间',
...
-- ----------------------------
-- Table structure for mk_order_detail
-- ----------------------------
...
-- ----------------------------
-- Table structure for mk_power
-- ----------------------------
DROP TABLE IF EXISTS `mk_power`;
CREATE TABLE `mk_power`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键id',
...
-- ----------------------------
-- Table structure for mk_question
-- ----------------------------
DROP TABLE IF EXISTS `mk_question`;
CREATE TABLE `mk_question`  (
...
-- ----------------------------
-- Table structure for mk_search_kw
-- ----------------------------
DROP TABLE IF EXISTS `mk_search_kw`;
CREATE TABLE `mk_search_kw`  (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for mk_search_log
-- ----------------------------
DROP TABLE IF EXISTS `mk_search_log`;
CREATE TABLE `mk_search_log`  (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
-- ----------------------------
-- Table structure for mk_system_setting
-- ----------------------------
DROP TABLE IF EXISTS `mk_system_setting`;
CREATE TABLE `mk_system_setting`  (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `mk_user`  (
  ...
  `openid` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户的openid',
  `is_auth` tinyint(1) NOT NULL DEFAULT 0 COMMENT '用户是否实名认证',
  `is_member` tinyint(4) NOT NULL DEFAULT 0 COMMENT '用户是否是会员',
  `member_expire_at` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户会员过期时间',
  `points` int(11) NOT NULL DEFAULT 0 COMMENT '用户积分',
  `created_at` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '创建时间',
  PRIMARY KEY (`uid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 907 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for mk_user_address
-- ----------------------------
DROP TABLE IF EXISTS `mk_user_address`;
CREATE TABLE `mk_user_address`  (
...
-- ----------------------------
-- Table structure for mk_user_click_log
-- ----------------------------
DROP TABLE IF EXISTS `mk_user_click_log`;
CREATE TABLE `mk_user_click_log`  (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
-- ----------------------------
-- Table structure for mk_user_coupon
-- ----------------------------
DROP TABLE IF EXISTS `mk_user_coupon`;
...
-- ----------------------------
-- Table structure for mk_user_fav
-- ----------------------------
DROP TABLE IF EXISTS `mk_user_fav`;
CREATE TABLE `mk_user_fav`  (
...
-- ----------------------------
-- Table structure for mk_user_fav_log
-- ----------------------------
DROP TABLE IF EXISTS `mk_user_fav_log`;
CREATE TABLE `mk_user_fav_log`  (
  `idx` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL COMMENT '用户ID',
  `goods_id` int(11) NOT NULL COMMENT '商品ID',
...
-- ----------------------------
-- Table structure for mk_user_point
-- ----------------------------
DROP TABLE IF EXISTS `mk_user_point`;
CREATE TABLE `mk_user_point`  (
...
-- ----------------------------
-- Table structure for mk_user_profile
-- ----------------------------
DROP TABLE IF EXISTS `mk_user_profile`;
CREATE TABLE `mk_user_profile`  (
  `uid` int(11) NOT NULL COMMENT '用户ID',
