	...
	$.fn.Huispinner = function(options, callback) {
		...
		this.each(function() {
			...
			var str = '<div class="spinner">'
					+ '<a class="subtract" href="javascript:;"><i>-</i></a>'
...
!function($) {
	...
	$.Huitotop = function(bottom){		
		...
		var str ='<a href="javascript:;" class="tools-right toTop Hui-iconfont" title="返回顶部" alt="返回顶部" style="display:none;bottom:'+bottom+'px">&#xe684;</a>';
